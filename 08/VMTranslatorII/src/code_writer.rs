...
impl CodeWriter {
    ...
    pub fn write_label(
        ...
        let label_asm: String = Branching::Label(arg1).value();
        writeln!(self.output_file, "{}", label_asm)?;
    ...
    pub fn write_goto(
        ...
        let label_asm: String = Branching::Goto(arg1).value();
        writeln!(self.output_file, "{}", label_asm)?;
    ...
    pub fn write_ifgoto(
        ...
        let label_asm: String = Branching::IfGoto(arg1).value();
        writeln!(self.output_file, "{}", label_asm)?;
